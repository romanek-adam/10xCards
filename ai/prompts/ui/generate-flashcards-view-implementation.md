...
<implementation_plan>
@ai/ui/generate-flashcards-view-implementation-plan.md
</implementation_plan>
...
Carefully analyze the implementation plan. Pay special attention to component structure, API integration requirements, and user interactions described in the plan.
...
2. View Implementation:
   - Identify all views listed in the plan.
   - Implement necessary views for each endpoint.
...
7. Performance Optimization:
   - Implement any performance optimizations specified in the plan.
...
Ensure that your implementation accurately reflects the provided implementation plan. Pay special attention to component structure, API integration, and handling of user interactions.
