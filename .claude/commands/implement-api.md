---
description: Implement a REST API endpoint from an implementation plan (incremental, 3 steps at a time)
---
...
IMPORTANT: Work incrementally. After implementing ~3 steps, summarize your progress and outline the next 3 steps, then STOP and wait for user feedback before continuing.
