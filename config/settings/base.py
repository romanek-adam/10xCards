...
MIGRATION_MODULES = {"sites": "flashcards.contrib.sites.migrations"}
...
ADMINS = [("""Adam Romanek""", "romanek.adam@gmail.com")]
...
SOCIALACCOUNT_ADAPTER = "flashcards.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
